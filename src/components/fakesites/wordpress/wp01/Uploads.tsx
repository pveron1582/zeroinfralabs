    ...
    <div className="min-h-full bg-white p-6">
      <div className="max-w-2xl mx-auto">
        <div className="bg-amber-50 border border-amber-200 rounded p-3 mb-4 flex items-center gap-2">
          ...
          <div>
            <div className="text-sm font-bold text-amber-800">Directory Listing Active</div>
            <div className="text-xs text-amber-700">This directory has public listing enabled.</div>
          </div>
        </div>
        ...
        <table className="w-full text-sm border border-gray-200 rounded overflow-hidden">
          <thead className="bg-gray-50">
            <tr>
              <th className="text-left px-3 py-2 text-xs text-gray-600 font-semibold">Name</th>
              <th className="text-left px-3 py-2 text-xs text-gray-600 font-semibold">Size</th>
              <th className="text-left px-3 py-2 text-xs text-gray-600 font-semibold">Date</th>
            </tr>
          </thead>
          <tbody>

...
const scenario02Data = {
  ...
  learningSteps: [
    ...
    { id: 2, task: 'Port Scanning', taskEs: 'Escaneo de puertos', text: 'Identify the services running on the target', textEs: 'Identificá los servicios que corren en el objetivo', targetMachineId: 'lab-scenario-02-ssh', discoveryLevel: 2, hints: { hint1: { en: 'Use nmap', es: 'Usá nmap' }, hint2: { en: 'nmap -sV <target-ip>', es: 'nmap -sV <ip-objetivo>' } }, validationCriteria: { type: 'scanResults' as const, port: 22 } },
    { id: 3, task: 'Web Reconnaissance', taskEs: 'Reconocimiento Web', text: 'Access the website to identify employees and possible usernames', textEs: 'Accedé al sitio web para identificar empleados y posibles nombres de usuario', targetMachineId: 'lab-scenario-02-ssh', discoveryLevel: 3, hints: { hint1: { en: 'Use the Firefox browser', es: 'Usá el navegador Firefox' }, hint2: { en: 'Click the Firefox button', es: 'Hacé clic en el botón Firefox' } }, validationCriteria: { type: 'custom' as const } },

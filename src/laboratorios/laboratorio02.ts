...
export const scenario_02: Scenario = buildScenario({
  ...
  targetMachine: {
    ...
    files: [
      ...createLinuxFileSystem({ username: 'gonzalo', extraUsers: [{ username: 'carla', gecos: 'Carla Medina' }, { username: 'diego', gecos: 'Diego Ruiz' }] }),
      createFile('/home/gonzalo/flag.txt', scenario02Data.flags.user),
    ],
    // Tabla de passwords del sistema: root + usuarios normales.
    known_passwords: {
      root: 'g0nz4l0_R00t#24',
      gonzalo: scenario02Data.credentials.pass,
      carla: 'letmein',
      diego: 'monkey',
    },
  },

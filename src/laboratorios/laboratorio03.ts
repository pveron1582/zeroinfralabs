...
export const SCENARIO_TEMPLATES_ETERNAL = {
  eternalBlue: () => ({
    ...
    tools: ['metasploit', 'nmap', 'eternalblue'],
    accentColor: '#f87171',
    description: 'Exploitation of the MS17-010 (EternalBlue) vulnerability on an unpatched Windows system. Achieve remote code execution through SMB port without authentication.',
    descriptionEs: 'Explotación de la vulnerabilidad MS17-010 (EternalBlue) en un sistema Windows sin parchear. Ejecutá código remoto a través del puerto SMB sin autenticación.',
    ...
    learningSteps: [
      ...
      { task: 'Port Scanning', taskEs: 'Escaneo de puertos', text: 'Identify the services running on the target', textEs: 'Identificá los servicios que corren en el objetivo', discoveryLevel: 2, hints: { hint1: { en: 'Use nmap', es: 'Usá nmap' }, hint2: { en: 'nmap -sS -p- --min-rate 5000 172.16.0.11', es: 'nmap -sS -p- --min-rate 5000 172.16.0.11' } }, validationCriteria: { type: 'scanResults' as const, port: 445 } },

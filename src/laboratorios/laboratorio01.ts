...
const scenario01Data = {
  ...
  learningSteps: [
    ...
    { task: 'Web Enumeration', taskEs: 'Enumeración Web', text: 'Access the website to enumerate its content', textEs: 'Accedé al sitio web para enumerar su contenido', discoveryLevel: 2, hints: { hint1: { en: 'Open the Firefox browser', es: 'Abrí el navegador Firefox' }, hint2: { en: 'Click the Firefox button in the taskbar and navigate to http://<ip>', es: 'Hacé clic en el botón Firefox en la barra de tareas y navega a http://<ip>' } }, validationCriteria: { type: 'custom' as const } },

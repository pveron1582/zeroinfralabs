...
export const SCENARIO_TEMPLATES_LFI = {
  lfiRce: () => ({
    ...
    learningSteps: [
      ...
      { task: 'Capture User Flag', taskEs: 'Capturar flag de usuario', text: 'Read the user flag to complete the lab', textEs: 'Leé la flag de usuario para completar el laboratorio', discoveryLevel: 4, hints: { hint1: { en: "Check the current directory", es: 'Revisá el directorio actual' }, hint2: { en: 'cat flag.txt', es: 'cat flag.txt' } }, validationCriteria: { type: 'fileRead' as const, fileType: 'flag' as const } },
    ],
  }),
};

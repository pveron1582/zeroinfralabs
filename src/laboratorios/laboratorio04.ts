...
export const SCENARIO_TEMPLATES_LFI = {
  lfiRce: () => ({
    ...
    learningSteps: [
      { task: 'Reconnaissance', taskEs: 'Reconocimiento', text: 'Discover the host on the network', textEs: 'Descubrí el host en la red', discoveryLevel: 1, hints: { hint1: { en: 'Use arp-scan', es: 'Usá arp-scan' }, hint2: { en: 'arp-scan 192.168.20.0/24', es: 'arp-scan 192.168.20.0/24' } } },
      { task: 'Scanning', taskEs: 'Escaneo', text: 'Identify the services running on the target', textEs: 'Identificá los servicios que corren en el objetivo', discoveryLevel: 2, hints: { hint1: { en: 'Use nmap', es: 'Usá nmap' }, hint2: { en: 'nmap -sV 192.168.20.11', es: 'nmap -sV 192.168.20.11' } } },
      ...
      { task: 'Prepare Payload', taskEs: 'Preparar Payload', text: 'Inspect the reverse shell payload file', textEs: 'Inspeccioná el archivo de la reverse shell', discoveryLevel: 3, hints: { hint1: { en: 'View the payload.php file', es: 'Visualizá el archivo payload.php' }, hint2: { en: 'cat /root/payload.php', es: 'cat /root/payload.php' } } },
      { task: 'Setup Listener', taskEs: 'Configurar Listener', text: 'Prepare a listener to receive the reverse shell', textEs: 'Prepará un listener para recibir la reverse shell', discoveryLevel: 3, hints: { hint1: { en: 'Use netcat', es: 'Usá netcat' }, hint2: { en: 'nc -nlvp 4444', es: 'nc -nlvp 4444' } } },
      { task: 'Remote Code Execution', taskEs: 'Ejecución Remota de Código', text: 'Upload the payload and execute it to get RCE', textEs: 'Subí el payload y ejecutalo para obtener RCE', discoveryLevel: 4, hints: { hint1: { en: 'Upload via /upload.php and execute via /files/', es: 'Subí por /upload.php y ejecutá por /files/' }, hint2: { en: 'Upload at /upload.php, execute at /files/payload.php', es: 'Subí en /upload.php, ejecutá en /files/payload.php' } } },
      { task: 'Capture User Flag', taskEs: 'Capturar flag de usuario', text: 'Read the user flag to complete the lab', textEs: 'Leé la flag de usuario para completar el laboratorio', discoveryLevel: 4, hints: { hint1: { en: "Check the current directory", es: 'Revisá el directorio actual' }, hint2: { en: 'cat flag.txt', es: 'cat flag.txt' } } },
    ],
  }),
};

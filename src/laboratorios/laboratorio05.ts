...
whoami`, type: 'text' },
  ...
  learningSteps: [
    ...
    { id: 7, task: 'Privilege Escalation', taskEs: 'Escalada de privilegios', text: 'Use vim to escalate and become root', textEs: 'Usá vim para escalar y ser root', discoveryLevel: 4, targetMachineId: 'lab-scenario-05-target', hints: { hint1: { en: 'You can execute vim in a single command to escalate and become root', es: 'Podes ejecutar vim en un solo comando para escalar y ser root'}, hint2: { en: "sudo vim -c '!bash'", es: "sudo vim -c '!bash'" } } },
